...
class MainActivity : AppCompatActivity() {
    ...
    private val adSize: AdSize
        get() {
            val display = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) { this.display } else {
    ...
    private fun setupNavController() {
        ...
        navController.addOnDestinationChangedListener { _, destination, _ ->
            if (
                destination.id == R.id.pricesHistoryGraphFragment ||
    ...
    private fun loadBanner() {
        ...
        binding.adAdaptivebannerMain.addView(adViewAdaptiveBanner)
        adViewAdaptiveBanner.adUnitId = resources.getString(R.string.banner_adUnitId)
